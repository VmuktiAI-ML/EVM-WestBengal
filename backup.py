...
BOOTH_CONFIDENCE  = 0.50
PERSON_CONFIDENCE = 0.20
PERSON_NMS_IOU_THRESH = 0.45
MIN_BOOTH_AREA_PX = 3000

PERSON_BOOTH_IOU_THRESH       = 0.20
PERSON_BOOTH_IOP_THRESH       = 0.20
PERSON_EVM_OVERLAP_IOP_THRESH = 0.20

EVM_ROI_EXPAND_LR_SCALE  = 0.00
EVM_ROI_EXPAND_TOP_SCALE = 0.07
DEAD_ZONE_SCALE          = 0.40
DEAD_ZONE_OVERLAP_THRESH = 0.10 
PROXIMITY_BOOTH_SCALE    = 0.25
PERSON_PERSON_IOP_THRESH = 0.25

# How much of the person must be inside the EVM area to count them
PERSON_BOOTH_IOU_THRESH = 0.50 
PERSON_BOOTH_IOP_THRESH = 0.50
